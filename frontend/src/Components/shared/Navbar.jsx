...
//         <div className="left">
//           <h1 className='text-2xl font-bold'>Job <span className='text-[#972081]'>Portal</span></h1>
//         </div>
...
//                 <Link to="/login"><Button className="bg-purple-500 hover:bg-purple-800"  >Login</Button></Link>
...
//                   </Avatar>
//                 </PopoverTrigger>
//                 <PopoverContent className='w-80  h-15 space-y-2'>
//                   <div className="">
//                     <Avatar>
//                       <AvatarImage src={user?.profile?.profilePhoto} alt="@shadcn" />
//                     </Avatar>
